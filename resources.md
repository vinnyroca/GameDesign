...
The Scripps Fab Lab requires a safety [quiz](https://docs.google.com/forms/d/e/1FAIpQLSfgE9ht_OvAo0DU9YPzdqEr0uWdMOYT8zpXbZtv8OajYHL8FA/viewform) for access. 


### Trotec Speedy 300 Laser Cutter (cutting size 27” by 17”)

Illustrator Laser Template for 12in by 20in ply [LINK](https://scrippscollege.box.com/s/4wu3riwjhn2e75lae2smi7fv1eavu8vo)
...
Information on resources and certifications can be found on the Makerspace [website.](https://make.hmc.edu/)  The General Usage manual for the Makerspace can be found [here](https://docs.google.com/document/d/1-pycsGqeUptorvEH-Ti66ssmvKLrtopvLRZ9YNMSMKo/edit?tab=t.0#heading=h.1vr8ghqzj9oj). 


The Makerspace contains a variety of resources. The general Makerspace includes a variety of crafting materials and supplies that can be used to produce many parts of a board game. Below are some example resources. These resources require certifications that can be found on the Makerspace [website](https://make.hmc.edu/areas).
